                    ...
                    <div className="hero-content">
                        ...
                        <div>
                            <p className="text-muted">
                                You can use the navbar-modal link or this page
                                for customers' sign in.
                            </p>
                        </div>
                    </div>
                </Container>
                        ...
                        <Col lg={{ size: 5, offset: 1 }}>
                            <Card>
                                ...
                                <CardBody className="p-5">
                                    ...
                                    <p className="text-muted text-sm">
                                        With registration with us new world of
                                        fashion, fantastic discounts and much
                                        more opens to you! The whole process
                                    ...
                                    <p className="text-muted text-sm">
                                        ...
                                        , our customer service center is working
                                        for you 24/7.
                                    </p>
                                    <hr className="my-4" />
                                    <Form action="/customer-orders">
