                        ...
                        <Col key={index} sm="6" lg="4" className="mb-5">
                            <div className="card-scale" data-aos="zoom-in">
                                <div className="img-scale-container mb-3">
                                    <img className="img-fluid img-scale" src={category.img} alt="" />
                                </div>
                                <h5>
                                    <Link href={category.link}>
                                        <a className="stretched-link text-reset"> {category.name}</a>
                                    </Link>
                                    <span className="text-sm text-muted ml-2">{category.productcount}</span>
                                </h5>
                            </div>
                        </Col>
                    )}
