                ...
                <Row className="px-xl-5">
                    ...
                    <Col lg="10" xl="8" className="docs-content text-lg">
                        <ul className="list-icon">
                            ...
                            <li className="mb-3"><strong>Vremena Grotesk </strong>- <a href="https://www.fontspring.com/fonts/abstrkt/vremena">https://www.fontspring.com/fonts/abstrkt/vremena</a></li>
                            ...
                            <li className="mb-3"><strong>AOS</strong> - <a href="https://michalsnik.github.io/aos/">https://michalsnik.github.io/aos/</a></li>
                            <li className="mb-3"><strong>React Parallax</strong> - <a href="https://github.com/rrutsche/react-parallax">https://github.com/rrutsche/react-parallax</a></li>
                            <li className="mb-3"><strong>React Magnifier</strong> - <a href="https://github.com/samuelmeuli/react-magnifier">https://github.com/samuelmeuli/react-magnifier</a></li>
                            <li className="mb-3"><strong>React Responsive Masonry</strong> - <a href="https://github.com/cedricdelpoux/react-responsive-masonry">https://github.com/cedricdelpoux/react-responsive-masonry</a></li>
                            ...
                            <li className="mb-3"><strong>Demo images from Bershka - not included in the download package.</strong>- <a href="https://www.bershka.com/">https://www.bershka.com/</a></li>
                        </ul>
                    </Col>
                </Row>
            </Container>
