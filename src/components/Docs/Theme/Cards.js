    ...
    return (
        <div id="cards" className="docs-item element">
            ...
            <div className="docs-desc mt-5">
                <p className="mb-3"><b>CardProduct component</b> - supported props</p>
                <ul>
                    <li><b>product</b> - product object</li>
                    <li><b>masonry</b> - if true, masonry image will be selected from product object</li>
                </ul>
                <Row className="mt-4">
            ...
            <div className="docs-desc mt-5">
                <p className="mb-3"><b>CardPost component</b> - supported props</p>
                <ul>
                    <li><b>post</b> - post object</li>
                    <li><b>category</b> - if true, category style view enabled</li>
                </ul>
                <Row className="mt-4">
