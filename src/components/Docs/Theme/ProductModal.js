    ...
    return (
        <div id="productmodal" className="docs-item element">
            ...
            <div className="docs-desc">
                <p className="lead">A component based on a Bootstrap modal with a product images carousel</p>
                <Button color="outline-primary" onClick={() => setQuickView(!quickView)}>Toggle product modal</Button>
            </div>
            <div className="mt-5">
                <ModalQuickView isOpen={quickView} toggle={() => setQuickView()} product={dummyProduct}/>
            </div>
            <div className="mt-5">
