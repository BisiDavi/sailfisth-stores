            ...
            <div className="mt-5">
                <Row>
                    <Col lg="6">
                        <Card className="mb-5 border-0 text-white dark-overlay">
                            <img src="/img/blog/ian-dooley-347962-unsplash.jpg" alt="" className="card-img" />
                            <a href="/category-full" className="tile-link" />
                            <div className="card-img-overlay d-flex align-items-center">
                                <div className="text-center w-100 overlay-content">
                                    <h2 className="display-4 font-weight-bold text-uppercase text-center mb-0">Ladies   </h2>
                                </div>
                            </div>
                        </Card>
                    </Col>
                ...
                <Card className="bg-gray-100 border-0">
                    <CardBody>
                        ...
                        <CardText><code>.dark-overlay</code> or <code>.light-overlay</code> - CSS class to be used on the element, accepts Boostrap responsive suffixes. (e.g. <code>.dark-overlay.dark-overlay-lg-0</code> creates overlay on smaller viewports and hides it on lg+ screens.)</CardText>
