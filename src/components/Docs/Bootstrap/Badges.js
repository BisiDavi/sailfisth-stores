    ...
    return (
        <div id="badges" className="docs-item element">
            ...
            <div className="docs-desc">
                ...
                <p>Add <code>-light</code> suffix to the class name to get lighter tones on badges.</p>
            </div>
            <div className="mt-5">
                <Card className="mb-3">
                    <CardBody>
                        ...
                        <h4>Example heading <Badge color="warning-light">New</Badge></h4>
                        <h5>Example heading <Badge color="info-light">New</Badge></h5>
                        <h6>Example heading <Badge color="success-light">New</Badge></h6>
                    </CardBody>
                </Card>
            </div>
            <div className="mt-4">
