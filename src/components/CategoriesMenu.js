            ...
            <Collapse isOpen={collapse[categories.name]} className="expand-lg">
                ...
                <div className="sidebar-icon-menu mt-4 mt-lg-0">
                    {categoriesArray.map(category =>
                        <div key={category.name} className="sidebar-icon-menu-item active" data-toggle="collapse" aria-expanded={collapse[category.name]} onClick={() => toggleCollapse(category.name)}>
